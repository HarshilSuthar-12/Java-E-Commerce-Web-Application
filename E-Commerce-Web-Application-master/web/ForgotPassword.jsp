            ...
            <div class="main_div">
                <div class="center_div">
                    <form method="Post">
                        ...
                        <div class="input_div">
                            <input type="email" name="resetmail" value="" onkeyup="MyFun()" placeholder="" autocomplete="off" required>
                            <label> Email Id </label>
                        </div>

                        <div class="input_div">
                            <input type="number" name="resetmobileno" value="" onkeyup="MyFun()" placeholder="" autocomplete="off" required>
                            <label> Mobile No </label>
                        </div>

                        <div style="height: fit-content; color: red; width: fit-content" id="mess"></div>
